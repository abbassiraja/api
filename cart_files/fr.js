...
Language.chat.missed_visitor = {
	"message": "Vous avez raté un appel"
};
Language.chat.missed_visitor_messagePreview = {
	"message": "Vous avez raté un appel de"
};
...
Language.form.EmailTranscriptSuccess = {
	"message": "Demande de transcription envoyée par courriel."
};
...
Language.form.EndChatMessage2 = {
	"message": "Merci d'avoir pris contact avec la team SECUTOP. Nous nous tenons à votre disposition si vous avez d'autres demandes."
};
